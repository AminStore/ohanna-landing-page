  ...
  return (
    ...
    >
      ...
      <View style={{ padding: GRID_PAD, gap: GRID_PAD }}>
        {/* Info cards — 2-col calculated grid */}
        ...
        {/* Return policy — dark section */}
        <View style={[styles.returnPolicy, { backgroundColor: colors.foreground }]}>
...
const styles = StyleSheet.create({
  ...
  infoCardTitle: { fontSize: FS.xs, fontFamily: "Cinzel_700Bold", letterSpacing: 1 },
  infoCardDesc: { fontSize: FS.sm, fontFamily: "Inter_400Regular", lineHeight: 17 },
  tableTitle: { fontSize: FS.md, fontFamily: "Cinzel_700Bold", letterSpacing: 2 },
  ...
  returnPolicy: { padding: GRID_PAD, gap: SP.md - 2 },
  returnTitle: { fontSize: FS.md, fontFamily: "Cinzel_700Bold", letterSpacing: 2 },

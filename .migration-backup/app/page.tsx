  ...
  return (
    <div className="min-h-screen bg-[#FDF8EF] text-[#1B1B1B] overflow-x-hidden">
          ...
          >
            <div className="sketchy-border-thick bg-[#FDF8EF] p-4 transform rotate-1 shadow-[8px_8px_0_#1B1B1B]">
              <Image
                ...
                alt="OHANNA — Modern pharaoh streetwear model wearing Egyptian-inspired hoodie"
                width={500}
                height={600}
      ...
      <section className="py-20 bg-[#FDF8EF] relative overflow-hidden">
        <div className="absolute inset-0 opacity-5 pointer-events-none" aria-hidden>
          <div
            ...
            style={{
              backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fillRule='evenodd'%3E%3Cg fill='%23C89D29' fillOpacity='0.15'%3E%3Cpath d='M30 30l15-15v30l-15-15zm-15 0l-15-15v30l15-15z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
            }}
          />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <FadeUp>
              ...
              <p className="text-[#1B1B1B]/75 leading-relaxed mb-6">
                ...
                Each design tells a story of pharaohs, gods, and the timeless rebellion of youth.
              </p>
              <p className="text-[#1B1B1B]/75 leading-relaxed mb-8">
            ...
            <FadeUp delay={0.15} className="relative hidden lg:block">
              <div className="sketchy-border-thick bg-[#FDF8EF] p-4 transform -rotate-2 shadow-[8px_8px_0_rgba(27,27,27,0.2)]">
                <Image
                  ...
                  alt="OHANNA heritage timeline — Egyptian culture meets streetwear"
                  width={400}
                  height={500}
                  className="w-full h-auto sketchy-border"
                />
      ...
      <section className="py-20 bg-[#1B1B1B] text-[#FDF8EF] relative overflow-hidden">
        <motion.div
          className="absolute top-10 left-10 text-8xl text-[#C89D29]/10 select-none"
        ...
        <motion.div
          className="absolute bottom-10 right-10 text-7xl text-[#C89D29]/10 select-none"
          animate={{ rotate: [0, -5, 0] }}
        ...
        <div className="container mx-auto px-4">
          <FadeUp className="text-center mb-14">
            ...
            <p className="text-[#FDF8EF]/50 max-w-md mx-auto text-sm">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {TESTIMONIALS.map((t, i) => (
              <FadeUp key={i} delay={i * 0.07}>
                <div className="bg-[#FDF8EF] text-[#1B1B1B] border-2 border-[#FDF8EF]/30 p-5 sketch-hover h-full">
                  <div className="flex text-[#C89D29] mb-3">
                    {[...Array(t.rating)].map((_, j) => (
                      <Star key={j} className="h-3.5 w-3.5 fill-current" />
                    ))}
                  </div>
                  <p className="text-sm text-[#1B1B1B]/75 italic mb-4 leading-relaxed">
                    "{t.quote}"
                  </p>
                  <div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#C89D29] to-[#E4D5B7] relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none opacity-20" aria-hidden>
          {["𓋹", "𓂀"].map((g, i) => (
            <span
              key={i}
              className={`absolute text-6xl text-[#1B1B1B] ${i === 0 ? "top-8 left-16" : "bottom-8 right-16"}`}
            >
              {g}
            </span>
          ))}
        ...
        <div className="container mx-auto px-4">
          <FadeUp className="text-center max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-[#1B1B1B]/70 max-w-xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/collection">
                <Button
                  size="lg"
                  className="bg-[#1B1B1B] text-[#FDF8EF] hover:bg-[#FDF8EF] hover:text-[#1B1B1B] sketchy-button font-black px-10 py-5 text-base"
                >
              ...
              <Link href="/culture">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-[#1B1B1B] text-[#1B1B1B] hover:bg-[#1B1B1B] hover:text-[#FDF8EF] sketchy-button font-black px-10 py-5 text-base bg-transparent"
                >
